...
CURMOD=${SLURM_SUBMIT_DIR}/model-04
echo $CURMOD

for LOOPI in 05 06 07 08 09 10
do
	...
	python Run-train-2.py ${CURMOD} /vast/home/bnebgen/scratch/HIPNN-Al-3/HIPNN-Al-03-0/ model-${LOOPI} /ram/tmp/md-${LOOPI}-a/:/ram/tmp/md-${LOOPI}-b/ 1023:1323
